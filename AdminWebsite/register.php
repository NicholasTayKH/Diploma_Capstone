    ...
    if(isset($_POST["submit"])){
        ...
        elseif(strpos($email, 'newinti.edu.my') === false){
            ...
            if($conn){
                ...
                if($password == $password2 && $duplicate==false){
                    $sql = "SELECT * FROM admins WHERE user = ?";
...
<head>
    ...
    <style>
        body {
            ...
            background: url('https://burst.shopifycdn.com/photos/breakfast-from-above.jpg?width=1200&format=pjpg&exif=0&iptc=0') no-repeat center fixed;
